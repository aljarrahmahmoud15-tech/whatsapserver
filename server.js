...
app.get("/api/public/operations-feed", (req, res) => {
  ...
  res.json({
    ...
    policy: { producerWalletRate: "12%", companyWalletRate: "4%", confirmingCaptainWalletRate: "-16% (12% downloader + 4% company)", captainCashRate: "100%", debtLimit: `${money(CAPTAIN_MIN_BALANCE_CENTS)} JOD`, idempotent: true },
  });
});

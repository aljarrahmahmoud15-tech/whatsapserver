...
<style>body{margin:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;color:#fff;font-family:Arial} .box{background:#fff;padding:20px;border-radius:16px} h1{color:#00d084}</style>
</head><body>
<h1>امسح QR بواتساب</h1>
<div class="box"><img src="${qrUrl}" style="width:300px;height:300px"></div>

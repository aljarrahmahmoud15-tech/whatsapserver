...
assert(source.includes('"تم تثبيت الحجز"'), "بطاقة التثبيت تحمل عنوان التثبيت");
assert(source.includes("الطلب باسم:"), "البطاقة تعرض اسم كابتن تنزيل الطلب فقط");
assert(source.includes("التنفيذ باسم:"), "البطاقة تعرض اسم كابتن التنفيذ فقط");

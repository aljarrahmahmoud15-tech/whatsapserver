...
assert.match(admin, /id="captainCleanupCard"/);
assert.match(admin, /executeCaptainCleanup\(\)/);
assert.match(admin, /DELETE_EMPTY_OUTSIDE_GROUP_AND_SUSPEND_LINKED/);
assert.match(admin, /expectedDeletableEmptyCount/);
